...
def main(image_filename):
    ...
    # ------- VIZUALIZATION - Code I added for vizualization -------
    ...
    for i in range(len(predictions)):
        ...
        image_cv = cv2.rectangle(image_cv, (x1, y1), (x2, y2), color=(0,0,0), thickness=2)
        ...
        cv2.putText(image_cv, label, (b[0], b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 1, (200, 0, 0), 3)
        cv2.putText(image_cv, label, (b[0], b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 1, (255, 255, 255), 1)

    cv2.imwrite("./predictions/predicted_cat_1.jpg", image_cv)
